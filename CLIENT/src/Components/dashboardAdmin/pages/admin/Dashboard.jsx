...
import CardTicket from "../../elements/CardTicket";
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-10">
        <h1 className="text-4xl text-white">Good morning, Maximiliano!</h1>
      ...
      <div>
        <h1 className="text-2xl text-white my-10">Turnos más recientes</h1>
      </div>
      <div className="bg-secondary-100 p-8 rounded-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-center mb-4 bg-secondary-900 p-4 rounded-xl">
          ...
          <div>
            ...
            <span> {hoy+"-"+mesActual+"-"+añoActual} </span>
          </div>
